...
def delete_album(request,album_id):
    ...
    #     context['alb_detail'] = AlbumModel.objects.get(pk=self.kwargs['pk'])
    #     return context
    #
    # def save(self, *args, **kwargs):
    #     print(kwargs['pk'])
    #     obj = super(AddSong, self).save(*args, **kwargs)
    #     if self.request:
    #         obj.user = self.request.user
    #     obj.save()
    #     return obj
    #
    # template_name = "DileepImage/add_song.html"
    # model = SongModel
...
#     model = ImageModel
#     template_name = "DileepImage/add_image.html"
#     fields = ['image_title']
